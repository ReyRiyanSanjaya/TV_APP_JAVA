...
import reysan.live.tv.Adapter.Adapter_New_tv;
...
public class All_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (Settings.grid){
            case 0: grid = new GridLayoutManager(All_Activity.this, 2);
                grid.setSpanCount(2);
                break;
            case 1: grid = new GridLayoutManager(All_Activity.this, 3);
                grid.setSpanCount(3);
                break;
            case 2: grid = new GridLayoutManager(All_Activity.this, 4);
                grid.setSpanCount(4);
                break;
            default: grid = new GridLayoutManager(All_Activity.this, 3);
                grid.setSpanCount(3);
        }
        ...
        methods = new Methods(this, new InterAdListener() {
            ...
            public void onClick(int position, String type) {
                NavigationUtil.Video(All_Activity.this, arrayList.get(position).getVideo_type(), position, arrayList);
            }
        });
    ...
    private void getData() {
        ...
        },methods.getAPIRequest(Settings.METHOD_ALL, page, "", "", "", "", "", "", "", "","","","","","","","", null));
        load.execute();
    ...
    public void setAdapter() {
        if (!isScroll) {
            adapter = new Adapter_New_tv(All_Activity.this,  arrayList,  new Adapter_New_tv.RecyclerItemClickListener() {
                @Override
