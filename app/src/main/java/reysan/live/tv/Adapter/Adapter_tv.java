package reysan.live.tv.Adapter;
...
public class Adapter_tv extends RecyclerView.Adapter {
    ...
    public Adapter_tv(Context context, ArrayList<Listltem> arrayList, RecyclerViewClickListener recyclerViewClickListener) {
