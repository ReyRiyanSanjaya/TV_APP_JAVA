...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void loadRegister() {
        if (methods.isNetworkAvailable()) {
            ...
            }, methods.getAPIRequest(Settings.METHOD_REGISTER, 0, "", "", "", "", "", "", "", "", "", editText_email.getText().toString(), editText_pass.getText().toString(), editText_name.getText().toString(), editText_phone.getText().toString(),"","", null));
