...
public class LoginActivity extends AppCompatActivity {
    ...
    private void loadLogin() {
        if (methods.isNetworkAvailable()) {
                ...
                public void onEnd(String success, String loginSuccess, String message, String user_id, String user_name) {
                    ...
                    if (success.equals("1")) {
                        if (loginSuccess.equals("1")) {
                            Settings.itemUser = new ItemUser(user_id, user_name, editText_email.getText().toString(), "");
                            if (rememberme.isChecked()) {
                                sharedPre.setLoginDetails(Settings.itemUser, rememberme.isChecked(), editText_password.getText().toString());
                            } else {
            ...
            }, methods.getAPIRequest(Settings.METHOD_LOGIN, 0,"","","","","","","","","", editText_email.getText().toString(), editText_password.getText().toString(),"","","","", null));
            loadLogin.execute();
        } else {
